...
@AndroidEntryPoint
class OnlineMusicFragment : Fragment(), PlaylistListSongItemClick {
    @Inject
    ...
    companion object {
        lateinit var binding: FragmentOnlineMusicBinding
    }
    ...
    override fun onCreateView(
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            viewModel.getAllPlaylistOnl(0).collect {
        ...
        binding.lnAddToFavorite.setOnClickListener {
            val action = PlaylistFragmentDirections.actionPlaylistFragmentToFavouriteFragment(0)
