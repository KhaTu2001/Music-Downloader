...
class GenreAdapter(private val callback: GenreItemClick):ListAdapter<DataX,GenreAdapter.ViewHolder>(
    GenreDiffCallback()
) {
    ...
    inner class ViewHolder(private var binding:ItemGenreBinding):RecyclerView.ViewHolder(binding.root) {
