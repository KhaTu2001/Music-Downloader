...
public class StrokeTextView extends AppCompatTextView {
    ...
    public StrokeTextView(Context context, AttributeSet attrs) {
        ...
        //取得客製化的xml名稱
        TypedArray attr = context.obtainStyledAttributes(attrs, com.ddona.music_download_ms3_tunk.R.styleable.StrokeTextView);
        //取得對應的屬性值
        this.mStroke = attr.getFloat(com.ddona.music_download_ms3_tunk.R.styleable.StrokeTextView_stroke,6);
        this.mStrokeColor =attr.getColor(com.ddona.music_download_ms3_tunk.R.styleable.StrokeTextView_strokeColor,Color.parseColor("#000000"));
        init();
    }
